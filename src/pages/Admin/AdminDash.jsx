...
const data = [
  ...
  const COLORS = ['#000000', '#0000FF', '#FF0000', '#00FF00', '#FFFF00', '#FF00FF', '#00FFFF', '#808080', '#800080', '#FFA500', '#A52A2A', '#C0C0C0'];
            ...
            <div className='top-div'>
                ...
                <ResponsiveContainer width="100%" height={400} >
                    <div className='bargraph'>
                        ...
                        <br></br>
                        <div >
                        <p className='monthsmall'> Volume (Monthly) of Hauls
                        <br></br>
                      <span  className='monthbig'>  Total - 42,000 </span>
                        </p>
